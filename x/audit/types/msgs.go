...
func NewMsgJoinAttackPool(poolId uint64, tokenIn sdk.Coin) *MsgJoinAttackPool {
	return &MsgJoinAttackPool{
		PoolId:  poolId,
		TokenIn: tokenIn.Amount,
	}
}
...
func NewMsgJoinDefensePool(poolId uint64, tokenIn sdk.Coin) *MsgJoinAttackPool {
	return &MsgJoinAttackPool{
		PoolId:  poolId,
		TokenIn: tokenIn.Amount,
	}
